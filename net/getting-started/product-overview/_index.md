...
### **Examples**
Here, you can see some code samples for simple operations, such as generating a barcode using the *Code128* symbology or recognizing a barcode from a file or stream.
