...
keywords: "Generate Swiss QR Codes, How to Create Swiss Barcodes, Swiss QR Code, Aspose.BarCode, Generate Barcode Java"
weight: 10
...
Specifically, the *Swiss QR Code* standard is used to work with QR bills in electronic payments. A *Swiss QR Code* barcode contains all necessary payment information required to launch payments or to process a QR invoice. ***Aspose.BarCode for Java*** includes [*SwissQRBill*]() and [*SwissQRCodetext*]() classes that provide various properties to work with *Swiss QR Code* barcodes.  
...
To generate a *Swiss QR Code* barcode using  ***Aspose.BarCode for Java***, it is necessary to create an instance of [*ComplexBarcodeGenerator*]() and specify the information to be encoded into [*SwissQRCodetext*]().  
