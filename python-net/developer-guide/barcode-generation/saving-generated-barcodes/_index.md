...
In ***Aspose.BarCode for Python via .NET***, barcode images can be saved to common raster image formats, namely, PNG, GIF, BMP, JPEG, and TIFF. The value of the [*BarCodeImageFormat*](https://reference.aspose.com/barcode/python-net/aspose.barcode.generation/barcodeimageformat/) enum can be passed as the second argument to the *save*. The description of all supported image formats is given further.
