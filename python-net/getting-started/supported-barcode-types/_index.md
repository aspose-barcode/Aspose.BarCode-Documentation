...
weight: 20
url: /python-net/barcode-types/
aliases:
- /python-net/barcode-types-and-file-formats/
---

## **Barcode Types**
***Aspose.BarCode for Python via .NET*** supports more than 60 [barcode types](/barcode/info-cards/) used in various industries, i.e., linear (1D), matrix (2D), and postal barcodes. 
