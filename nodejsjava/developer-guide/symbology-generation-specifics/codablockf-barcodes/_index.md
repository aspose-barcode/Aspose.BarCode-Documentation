...
## **Layout Settings**
To adjust the layout of a *Codablock-F* barcode in terms of the number of columns and rows, *setColumns* and *setRows* methods of class [*CodablockParameters*](https://reference.aspose.com/barcode/nodejs/CodablockParameters) can be used. The maximum values of columns and rows can be 62 and 44, respectively.  
