...
### **Unicode Metadata**
In ***Aspose.BarCode for Node.js via Java***, it is possible to re-encode optional metadata using the Unicode encoding through the *setPdf417MacroECIEncoding* method of class [*Pdf417Parameters*](). This method is intended to perform the conversion of metadata and send it along with the related encoding identifier. 
