...
weight: 20
url: /python-java/recognition-settings/
---
...
## **Overview**
In the barcode recognition process implemented in ***Aspose.BarCode for Python via Java***, barcode data decoding is initiated according to the special protocol after scanning the raw data from a graphical representation. Some linear and postal barcode types have passed standardization after their wide implementation, and therefore, it has lead to the presence of incompatible decoding formats. To resolve possible conflicts, class [*BarCodeReader*](https://reference.aspose.com/barcode/python-java/class/asposebarcode.recognition.bar_code_reader/) provides a special class called [*BarcodeSettings*](https://reference.aspose.com/barcode/python-java/class/asposebarcode.recognition.barcode_settings/) used to manage barcode decoding settings.
...
***Aspose.BarCode for Python via Java*** provides class [*BarcodeSettings*](https://reference.aspose.com/barcode/python-java/class/asposebarcode.recognition.barcode_settings/) that contains a special method called *setDetectEncoding* that enables the automatic recognition of UTF8 and UTF16 Unicode encodings for 2D symbologies and allows re-encoding barcode information into a string with Unicode characters. If this recognition mode is turned off, barcode information can be scanned and decoded manually based on the desired encoding.  
...
Because of the possible presence of customer information in barcode information for *Australia Post*, the recognition process has some peculiarities. ***Aspose.BarCode for Python via Java*** provides class [*AustraliaPostSettings*](https://reference.aspose.com/barcode/python-java/class/asposebarcode.recognition.australia_post_settings/) to manage recognition parameters according to specific industrial needs. 

### **Decoding Customer Information in Standard Formats**
The *Australia Post* standard enables encoding additional customer data in three formats; automatic detection of the used format is not supported. The desired decoding format can be enabled through the *setCustomerInformationInterpretingType* method of class [*CustomerInformationInterpretingType*](https://reference.aspose.com/barcode/python-java/class/asposebarcode.recognition.customer_information_interpreting_type/). This method can take different values explained in the table below.
