---
title: Aspose.BarCode for Python via Java 22.12
type: docs
weight: 800
url: /java/aspose-barcode-for-python-via-java-22-12/
---

{{% alert color="primary" %}} 

This page contains release notes information for [Aspose.BarCode for Python via Java 22.12](https://downloads.aspose.com/barcode/python-java/new-releases/aspose.barcode-for-python-via-java-22.12/).
