---
title: Aspose.BarCode for Python via Java 23.4
type: docs
weight: 970
url: /java/aspose-barcode-for-python-via-java-23-4/
---

{{% alert color="primary" %}} 

This page contains release notes information for [Aspose.BarCode for Python via Java 23.4](https://downloads.aspose.com/barcode/python-java/new-releases/aspose.barcode-for-python-via-java-23.4/).
